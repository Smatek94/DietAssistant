...
import com.skolimowskim.dietassistant.view.meals.manage.ManageMealViewModel
...
class ViewModelModule {
    ...
    @Provides
    @Singleton
    internal fun provideManageMealViewModel(mealsRepo: MealsRepo) = ManageMealViewModel(mealsRepo)
}